...
published: yes
image:
  url: "../images/posts/icons_joacim_eldre.webp"
...
![Four vector icons, from top left to bottom right: totem pole, three stars, potted plant, robot head](../images/posts/fun_icons_1.webp "Totem pole, three stars, potted plant, and a robot head vector icon")
...
![Four vector icons, from top left to bottom right: scallop shell, rubber duck, key, lightning bolt](../images/posts/fun_icons_2.webp "Scallop shell, rubber duck, key, and a lightning bolt vector icon")
...
![Four vector icons, from top left to bottom right: a washing machine, a bear, a smiling face sun, a bat](../images/posts/fun_icons_3.webp "Washing machine, bear, smiling face sun, and a bat vector icon")
...
![A bunch of vector icons, too many to describe. I'm sorry screen readers!](../images/posts/icon_grid.webp "A bunch of vector icons")
