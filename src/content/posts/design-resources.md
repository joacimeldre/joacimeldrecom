...
[Conversations on Quality](https://linear.app/quality) is a video series of interviews with designers, hosted by Linear.

[Design Notes](https://designnotes.fm/) is a podcast about creative work.

[User experience in LEGO interfaces](https://interactionmagic.com/UX-LEGO-Interfaces/) explores the various interfaces that exist in LEGO.

[Ollie Hoff](https://www.olliehoff.co.uk/) is an illustrator and graphic designer.

[Headspace](https://www.headspace.com/) is an app for meditation and sleep.
...
[Shift Happens](https://shifthappens.site/) is a book about typewriters and keyboards.

[Morten Kantsø](http://kantsoe.com/) is an illustrator.

[Simple Bits](https://simplebits.shop/) is a tiny type foundry, goods shop, and design studio who make handmade letters and numbers.

[IORAMA](https://www.iorama.studio/) makes apps inspired by musical instruments and video games.

[A Playful Path](https://www.aplayfulpath.com/the-book/) is a book about play, being playful, and playfulness.
...
Paper. Anything goes, but I prefer thick and grainy paper.

Tablet computer with pressure sensitive touch display. I use an iPad.

Tablet stylus. I use an Apple Pencil.
...
[Learning Through Play](https://learningthroughplay.com/) is a website with articles and guidelines for the importance of play, and being playful as a way to learn.
...
[Design Systems](https://www.designsystems.com/) is a design systems publication by Figma.
...
[The Design Sprint](https://www.thesprintbook.com/the-design-sprint) is a book on how to build and test a prototype in five days.
...
[When Coffee and Kale Compete](https://www.revealed.market/when-coffee-and-kale-compete) is a free PDF book on how to find and solve the core problem.
...
[Refactoring UI](https://www.refactoringui.com/) is a book about front-end design.
...
[Don't Make Me Think](https://sensible.com/dont-make-me-think/) is a book about building usable services and products on a digital screen.
