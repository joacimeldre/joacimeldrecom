...
A while back [I wrote about an idea for a tiny video game](/posts/2026-02-20-start-of-bloob). Now Bloob is playable! Play it below or on [Lexaloffle](https://www.lexaloffle.com/bbs/?pid=bloob).

<iframe
  src="/pico-8/bloob/bloob.html"
  title="Play Bloob, a PICO-8 game"
  class="bloob-embed"
...
![Download Bloob as a PNG file](/pico-8/bloob/bloob.p8.png "Bloob cartridge")
...
- _Knitris_. A tiny game about tetris and knitting.
- _Stackasnack_. A tiny game about stacking and kicking snacks.
- [_Shapedrifter_](/posts/2026-07-22-shapedrifter) (is done). A tiny game about drifting and shapes.
- _Climb? Climb! Mountain /\\_. A tiny game about climbing a mountain.
- _Boomb_. A tiny game about a bomb that does bomb things. Might include slinging and deck building.
- _Catto_. A tiny game about a tiny cat that just wants to hug their friend. But stuff happen.
